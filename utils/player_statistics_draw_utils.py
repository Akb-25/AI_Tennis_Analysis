...
def draw_player_stats(output_video_frames,player_stats):
    for index,row in player_stats.iterrows():
        player_1_hit_speed=row['player_1_last_hit_speed']
        ...
        text = f"{player_1_hit_speed:.1f} km/h    {player_2_hit_speed:.1f} km/h"
        ...
        text = f"{avg_player_1_hit_speed:.1f} km/h    {avg_player_2_hit_speed:.1f} km/h"
